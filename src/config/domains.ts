...
const nudifyIm: DomainConfig = {
  ...
  features: [
    ...
    { icon: '🆓', title: 'Free Daily Credits', desc: 'Get 10 free nudifications every day. Start instantly, upgrade when you want.' },
  ...
  subpages: [
    ...
    },
    {
      ...
      faqs: [
        ...
        { q: 'Can I try before I buy?', a: 'Absolutely. You get 10 free nudifications every day with no credit card.' },
    ...
    },
    {
      ...
      faqs: [
        ...
        { q: 'How many free nudifications do I get?', a: '10 per day, refreshed at midnight UTC. No credit card required.' },
    ...
    },
    {
      ...
      faqs: [
        ...
        { q: 'What\'s the difference between free and paid?', a: 'Free plan: 10/day, watermarked downloads. Paid: no watermarks, batch processing, free retries.' },
    ...
    },
    {
      ...
      body: [
        "Nudify.im is a fully responsive progressive web app. On iPhone, open Safari and navigate to nudify.im. On Android, use Chrome or any modern browser. The full feature set is available on mobile: all 19 styles, 10 free daily credits, gallery, and sharing — identical to the desktop experience.",
...
const nudifyMy: DomainConfig = {
  ...
  stats: [
    ...
    { value: 'Free', label: '10 daily credits' },
  ],
  features: [
    ...
    { icon: '💎', title: 'Free Daily Credits', desc: '10 free nudifications every day. Start now, upgrade when you\'re ready.' },
  ...
  subpages: [
    {
      ...
      faqs: [
        ...
        { q: 'Is it really free?', a: 'Yes — 10 free nudifications every day with no credit card.' },
    ...
    },
    {
      ...
      body: [
        '1. Open Nudify.my and click "Nudify My Photo Free". You don\'t need to create an account — we give you 10 free daily credits automatically.',
      ...
      faqs: [
        { q: 'Do I need an account to nudify my photo?', a: 'No — just open the app and you\'re given 10 free daily credits automatically.' },
    ...
    },
    {
      ...
      body: [
        'Free credits refresh every day. If you don\'t use them, they reset — so check back daily for your 10 free nudifications.',
        ...
        'Need more than 10 per day? Buy a diamond pack starting at just $4.99 for 60 nudifications. Credits never expire.',
      ],
      faqs: [
        { q: 'How many free nudifications per day?', a: '10 per day, resetting at midnight UTC.' },
    ...
    },
    {
      ...
      faqs: [
        { q: 'Is Nudify.my the cheapest option?', a: 'Our free tier (10/day) and lowest paid pack ($4.99/60) are among the most competitive in the market.' },
        ...
        { q: 'Can I switch from a competitor?', a: 'Yes — just create an account at Nudify.my. No import needed, start fresh with 10 free daily credits.' },
      ],
    },
    {
    ...
    },
    {
      ...
      metaDescription: 'Learn how AI removes clothing from photos. Nudify.my uses generative AI to remove clothes in seconds. Private, realistic, free to try with 10 daily credits.',
  ...
  subpages: [
    ...
    },
    {
      ...
      faqs: [
        ...
        { q: 'How do I get started?', a: 'Click "Generate Nude Pics Free". 10 daily credits given automatically.' },
      ],
    },
    {
      slug: 'how-it-works',
    ...
    },
    {
      ...
      faqs: [
        { q: 'How many free nude pics per day?', a: '10 per day, refreshed at midnight UTC.' },
    ...
    },
    {
      ...
      body: [
        ...
        'Price: Free plan with 10 daily credits. Paid from $4.99/60 credits. Better value than most.',
      ],
      faqs: [
    ...
    },
    {
      ...
      metaDescription: 'The best AI nude photo tools in 2026 compared. Nudify.pics ranked #1 for quality, speed, privacy, and price. Free to try with 10 daily credits.',
    ...
    },
    {
      ...
      metaDescription: 'Get watermark-free AI nude photos at Nudify.pics. Full resolution results with any paid diamond pack. Free plan gives 10 daily credits with watermark.',
...
const nudieApp: DomainConfig = {
  ...
  subpages: [
    ...
    },
    {
      ...
      faqs: [
        { q: 'Do I need to create an account?', a: 'No — just open the app for 10 free daily credits.' },
        { q: 'How long does it take?', a: 'Under 10 seconds for most photos.' },
    ...
    },
    {
      ...
      metaDescription: 'Use the Nudie.app nude AI app for free. 10 free AI nude generations every day. No credit card.',
      ...
      faqs: [
        { q: 'Is Nudie.app really free?', a: 'Yes — 10 free nude AI generations per day, no card needed.' },
    ...
    },
    {
      ...
      metaDescription: 'The best free nudify app in 2026. Nudie.app works on any mobile device — no download required. 10 free AI nudifications daily. Photorealistic, private, instant.',
      ...
      faqs: [
        { q: 'Is there a free nudify app for mobile?', a: 'Yes — Nudie.app works in any mobile browser with 10 free daily credits. No download or account required.' },
    ...
    },
    {
      ...
      body: [
        "The best nudify app in 2026 must work on iOS and Android, deliver photorealistic results, protect privacy, and offer fair pricing. Nudie.app is the top-rated option on all four criteria: mobile-optimized web app, A100 GPU realism, 30-second photo deletion, and 10 free daily credits.",
      ...
      faqs: [
        { q: 'What is the best nudify app for iPhone in 2026?', a: 'Nudie.app — works in Safari with no download, 10 free daily credits, photorealistic A100 GPU results, and 30-second photo deletion.' },
    ...
    },
    {
      ...
      intro: "Nudify AI is a software application that uses generative models to digitally remove clothing from photos. Nudie.app is the best AI undress app for mobile — fully browser-based, works on iPhone and Android, 10 free daily credits, no download required.",
      body: [
    ...
    },
    {
      ...
      metaDescription: 'The best free AI clothes remover app in 2026. Nudie.app removes clothing from photos in seconds on any device. No download, 10 free daily credits, private.',
      h1: 'AI Clothes Remover App — Top Free Options 2026',
      intro: "Nudify AI is a software application that uses generative models to digitally remove clothing from photos. Nudie.app is the top-rated free AI clothes remover app in 2026 — browser-based, no download required, and 10 free credits per day.",
      body: [
      ...
      faqs: [
        { q: 'What is the best free AI clothes remover app in 2026?', a: 'Nudie.app — browser-based, no download, A100 GPU quality, 10 free daily credits, 30-second photo deletion.' },
    ...
    },
    {
      ...
      metaDescription: 'Nudify AI on Android with Nudie.app. Works in Chrome browser — no Google Play install required. 10 free daily credits, photorealistic results in seconds.',
    ...
    },
    {
      ...
      metaDescription: 'Nudify AI on iPhone with Nudie.app. Works directly in Safari — no App Store download needed. 10 free daily credits, photorealistic results, private.',
      ...
      body: [
        "To nudify on iPhone: open Safari, navigate to nudie.app, and the full web app loads immediately. The mobile-optimized interface works perfectly on all iPhone screen sizes — from iPhone SE to Pro Max. All 19 styles, 10 free daily credits, and the full gallery are available from your first visit.",
...
const undressCat: DomainConfig = {
  ...
  stats: [
    ...
    { value: '10/day', label: 'Free credits' },
  ],
  features: [
  ...
  subpages: [
    ...
    },
    {
      ...
      faqs: [
        { q: 'Do I need an account?', a: 'No — 10 free daily credits given automatically.' },
    ...
    },
    {
      ...
      metaDescription: 'Undress photos with AI for free. 10 free AI undress results every day at Undress.cat. No credit card.',
      ...
      faqs: [
        { q: 'How many free undress results per day?', a: '10 per day, reset at midnight UTC.' },
    ...
    },
    {
      ...
      body: [
        ...
        'Price: 10 free/day + $4.99/60 credits. Credits never expire.',
      ],
      faqs: [
    ...
    },
    {
      ...
      body: [
        "Undress.cat is a progressive web app optimized for mobile. Open it in Safari on iPhone, Chrome on Android, or any other modern mobile browser — the full feature set is immediately available. All 19 undress styles, 10 free daily credits, gallery, and sharing work identically on mobile and desktop.",
